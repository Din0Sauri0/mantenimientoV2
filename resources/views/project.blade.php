...
<div class="p-5 grid h-[10%] w-full justify-center">
    <div class="flex flex-col justify-items-center max-w-xl p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        ...
        <a href="{{ route('project.create') }}" class="font-normal text-gray-700 dark:text-gray-400 text-center hover:text-blue-500 hover:underline">Pincha aquí para agregar un nuevo!</a>
    </div>
</div>
@else
<div class="p-5">
    <div class="flex justify-between content-center mb-5">
        <div>
            <a href="{{ route('project.create') }}" class="text-white bg-orange-400 hover:bg-orange-600 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Agregar</a>
        </div>
        @if (Session::has('msg'))
        <div id="toast-success" class="absolute z-10 top-1.5 right-1.5 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
