        ...
        <form action="{{ route('register.post') }}" method="POST" class='flex flex-col p-2 gap-3 mt-3'>
            ...
            <div class="flex flex-col">
                ...
                <div class='relative flex items-center'>
                    ...
                    <input class='@error('id')bg-red-50 border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 @enderror text-sm rounded-lg block w-full p-2.5 pl-9' type="text" name="id" id="id">
                </div>
            </div>
            <div class="flex flex-col">
