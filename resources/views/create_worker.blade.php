...
<div class="p-5 w-full grid gap-5 justify-center items-center">
    <form action="{{ route('worker.store') }}" method="POST" class="bg-white p-5 rounded-xl shadow-xl">
        ...
        <div class="mb-6">
            ...
            <input value="{{ old('id') }}" type="text" id="id" name="id" class='bg-gray-100 border-orange-400 text-sm rounded-lg block w-full p-2.5 @error('id')bg-red-50 border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 @enderror' placeholder="12.345.678-9">
        ...
        <div class="flex flex-row gap-5 mb-6">
            <div class="w-full">
                ...
                <input value="{{ old('name') }}" type="text" id="name" name="name" class='bg-gray-100 border-orange-400 text-sm rounded-lg block w-full p-2.5 @error('id')bg-red-50 border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 @enderror' placeholder="Juan">
            ...
            <div class="w-full">
                ...
                <input value="{{ old('last_name') }}" type="text" id="last_name" name="last_name" class='bg-gray-100 border-orange-400 text-sm rounded-lg block w-full p-2.5 @error('id')bg-red-50 border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 @enderror' placeholder="Perez">
