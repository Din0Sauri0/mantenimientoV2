...
<body class="relative">
    <div class='w-screen h-screen relative lg:h-screen 2xl:flex 2xl:flex-row xl:flex xl:flex-row lg:flex lg:flex-row md:flex md:flex-row sm:flex sm:flex-row' style='background-color: #eee;'>
        ...
        <div id="toast-danger" class="absolute top-1.5 right-1.5 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
